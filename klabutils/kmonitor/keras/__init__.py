...
if "keras" in sys.modules:
    ...
    try:
        print("import kmonitor.keras called before import keras or import tensorflow.keras.  This can lead to a version mismatch, kmonitor now assumes tensorflow.keras")
        import tensorflow.keras as keras
        import tensorflow.keras.backend as K
    except ImportError:
        import keras
...
def is_generator_like(data):
    ...
    iterator_ops = klabutils.util.get_module(
...
def is_dataset(data):
    dataset_ops = klabutils.util.get_module(
...
def patch_tf_keras():
    ...
    training_v2 = klabutils.util.get_module('tensorflow.python.keras.engine.training_v2')
